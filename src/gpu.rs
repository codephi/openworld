        ...
        Ok(result) => {
            ...
            for line in lines.iter().skip(1) {
                ...
                if !trimmed.is_empty() && trimmed != "Name" {
                    ...
                    if trimmed.contains("NVIDIA") || trimmed.contains("AMD") || 
                       trimmed.contains("Radeon") || trimmed.contains("GeForce") {
                        // Extrai o nome
...
impl GpuPasswordGenerator {
    pub fn new(charset: &str) -> Result<Self, String> {
        ...
        // Carrega shader
        let shader_source = include_str!("password_gen.wgsl");
    ...
    pub fn generate_batch(
        ...
        let charset_buffer = self.device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
        ...
        
        {
            ...
            compute_pass.dispatch_workgroups((batch_size as u32 + 63) / 64, 1, 1);
        }
